"""
Configuration file to reproduce TF-DWT experiment results from 20250925_021227
This configuration replicates the exact settings used to generate tfdwt_summary_stats_20250925_021227.csv
"""
...
NESTED_CV_TRIALS_PER_SUBJECT_P3 = 10    # As logged: "trials_per_subject_P3: 20"
NESTED_CV_TRIALS_PER_SUBJECT_AVO = 80  # As logged: "trials_per_subject_AVO: 200"
...
EARLY_STOPPING_PATIENCE = 20  # As logged: early stopping patience = 50
...
"""
This configuration reproduces the exact experiment from 20250925_021227 with results:
- Overall accuracy: 0.6297 ± 0.0255
- 95% Confidence Interval: [0.6192, 0.6402]
- P3 Dataset - Mean Accuracy: 0.5853 | 95% CI: [0.5702, 0.6003]
- AVO Dataset - Mean Accuracy: 0.6415 | 95% CI: [0.6298, 0.6531]

Key settings extracted from log_batch/tfdwt_combined_P3_20_AVO_200_20250925_015533.log:
- electrode_list: all
- fusion_method: none
...
2. Replace with this file: cp config_reproduce_tfdwt_20250925_021227.py config.py
