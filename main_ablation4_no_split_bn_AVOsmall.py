...
def main():
    ...
    try:
        ...
        # Logger setup
        logger = setup_logger('Ablation4_AVOsmall_NoSplitBN', create_file=True)
        ...
        if 'detailed_fold_results' in results:
            ...
            csv_filename = f'ablation_results_AVOsmall/ablation4_no_split_bn_detailed_{timestamp}.csv'
            ...
            summary_filename = f'ablation_results_AVOsmall/ablation4_no_split_bn_summary_{timestamp}.csv'
