...
def main():
    ...
    try:
        ...
        # Logger setup
        logger = setup_logger('Ablation3_NoMMD', create_file=True)
        ...
        if 'detailed_fold_results' in results:
            ...
            csv_filename = f'ablation_results/ablation3_no_mmd_detailed_{timestamp}.csv'
            ...
            summary_filename = f'ablation_results/ablation3_no_mmd_summary_{timestamp}.csv'
