...
def main():
    ...
    try:
        ...
        # Logger setup
        logger = setup_logger('Ablation2_FixedWeights', create_file=True)
        ...
        if 'detailed_fold_results' in results:
            ...
            csv_filename = f'ablation_results/ablation2_fixed_weights_detailed_{timestamp}.csv'
            ...
            summary_filename = f'ablation_results/ablation2_fixed_weights_summary_{timestamp}.csv'
