...
def main():
    ...
    try:
        ...
        # Logger setup
        logger = setup_logger('Ablation1_EqualWeights', create_file=True)
        ...
        if 'detailed_fold_results' in results:
            ...
            csv_filename = f'ablation_results/ablation1_equal_weights_detailed_{timestamp}.csv'
            ...
            summary_filename = f'ablation_results/ablation1_equal_weights_summary_{timestamp}.csv'
